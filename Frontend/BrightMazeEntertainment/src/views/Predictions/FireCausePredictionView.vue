...
function handleCoords(coords) {
  // Reset all prediction results by replacing the form object
  form.value = {
    ...form.value,
    latitude: coords.latitude,
    longitude: coords.longitude,
    // keep county, date, but reset prediction fields
    temperature: '',
    wind: '',
    location: '',
    // do not reset date/county so user can keep selecting
  }
}
...
<template>
  <div class="container">
    ...
    <div class="form-section">
      <PredictionForm :form="form" mode="cause" @update:form="val => Object.assign(form, val)" />
    </div>
  </div>
</template>
